...
const securityFeatures = [
  ...
  {
    title: "Zero Trust Knowledge Access",
    description: "Every organizational insight is permission-aware and authorized",
    ascii: `  ┌───┐
  │ ✓ │
  └───┘`
  },
  ...
  {
    title: "GDPR-Compliant Organizational Memory",
    description: "Protect knowledge across every region and workspace",
    ascii: `  [===]
  [===]`
  },
  {
    title: "Role-Based Intelligence Permissions",
    description: "Granular access to insights, evidence, and decisions",
    ascii: `  ◉─◉─◉
  │ │ │`
  },
  {
    title: "Complete Audit & Decision Traceability",
    description: "Trace every insight back to its evidence and history",
    ascii: `  ▪ ▪ ▪
  ▪ ▪ ▪`
  },
];
  ...
  return (
    <section ref={sectionRef} className="relative py-32 bg-muted/30 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <p className="text-sm font-mono text-primary mb-4">// ENTERPRISE KNOWLEDGE GOVERNANCE</p>
          <h2 className="text-4xl lg:text-5xl font-semibold tracking-tight mb-6 text-balance">
            Intelligence you can trust.
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Every organizational insight is permission-aware, auditable, and protected by enterprise-grade security controls.
          </p>
        </div>
