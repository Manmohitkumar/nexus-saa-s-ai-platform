    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-24">
        ...
        <div className="text-center max-w-5xl mx-auto mb-10">
          ...
          >
            <span className="text-balance">Build the Digital Brain</span>
            <br />
            <span className="text-balance">of your</span>{" "}
          ...
          >
            Connect repositories, documents, meetings, APIs, and team knowledge into a living organizational intelligence system that learns, explains decisions, predicts risks, and helps your company think collectively.
          </p>
        </div>
        ...
        <p className="text-center text-xs font-mono text-primary/80 tracking-[0.2em] mb-3">// LIVE ORGANIZATIONAL INTELLIGENCE</p>
        <div 
        ...
        >
          {[
            { value: "92%", label: "knowledge coverage across connected systems", company: "COVERAGE" },
            { value: "4.8x", label: "faster onboarding for new engineers", company: "ONBOARDING" },
            { value: "73%", label: "reduction in undocumented dependency risk", company: "RISK" },
            { value: "18,400+", label: "organizational relationships mapped", company: "RELATIONSHIPS" },
          ].map((stat) => (
