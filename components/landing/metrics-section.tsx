...
const metrics = [
  { 
    value: 1.2, 
    suffix: "M", 
    label: "Knowledge entities indexed",
    sublabel: "Across connected workspaces"
  },
  { 
    value: 99.99, 
    suffix: "%", 
    label: "Organizational memory availability",
    sublabel: "Permission-aware by default"
  },
  { 
    value: 41, 
    suffix: "ms", 
    label: "Semantic query response time",
    sublabel: "Median across the graph"
  },
  { 
    value: 184, 
    suffix: "", 
    label: "Connected enterprise systems",
    sublabel: "Sources synchronized"
  },
];
    ...
    <section id="metrics" className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-16">
          <div>
            <p className="text-sm font-mono text-primary mb-3">// LIVE ORGANIZATIONAL BRAIN</p>
            <h2 className="text-3xl lg:text-5xl font-semibold tracking-tight text-balance">
              Real-time organizational<br />intelligence.
            </h2>
          </div>
        ...
        <div className="mt-12 p-6 rounded-xl bg-card border border-border card-shadow">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-mono text-sm text-muted-foreground">Knowledge activity feed</span>
          </div>
          <div className="font-mono text-xs space-y-2 text-muted-foreground overflow-hidden h-24">
            <ActivityLine time="now" event="Knowledge graph updated" region="engineering" status="SYNC" latency="41ms" />
            <ActivityLine time="1s" event="Architecture decision indexed" region="platform" status="NEW" latency="38ms" />
            <ActivityLine time="2s" event="Risk score recalculated" region="security" status="READY" latency="52ms" />
            <ActivityLine time="3s" event="Documentation auto-generated" region="payments" status="DONE" latency="44ms" />
            <ActivityLine time="4s" event="Ownership dependency changed" region="operations" status="SYNC" latency="47ms" />
          </div>
        </div>
      </div>
    </section>
