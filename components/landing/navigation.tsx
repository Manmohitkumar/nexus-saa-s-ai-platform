...
const navLinks = [
  ...
  { name: "How Phoenix Works", href: "#how-it-works" },
  { name: "Live Brain", href: "#metrics" },
  { name: "For Engineering", href: "#developers" },
];
      ...
      <nav className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <a href="#" className="flex items-center gap-3 group">
            ...
            <span className="text-xl font-bold tracking-tight">Project Phoenix</span>
          </a>
