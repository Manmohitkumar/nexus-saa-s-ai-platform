...
const features = [
  {
    ...
    description: "Interactive knowledge graph connecting teams, repositories, services, APIs, and business decisions.",
    animationKey: "neural" as const,
  },
  {
    title: "Decision Time Machine",
    description: "Replay the complete history behind architectural and operational decisions with evidence and timelines.",
    animationKey: "workflow" as const,
  },
  {
    title: "Employee Exit Simulation",
    description: "Predict knowledge loss, ownership concentration, and onboarding impact before critical expertise disappears.",
    animationKey: "security" as const,
  },
  {
    title: "Knowledge Risk Heatmap",
    description: "Visualize undocumented systems, single points of failure, and organizational knowledge silos in real time.",
    animationKey: "analytics" as const,
  },
  {
    title: "Autonomous Documentation",
    description: "Generate architecture docs, API references, onboarding guides, and release summaries from code and meetings.",
    animationKey: "globe" as const,
  },
  {
    title: "AI Organizational Mentor",
    description: "A context-aware assistant that explains systems, dependencies, historical decisions, and best practices.",
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            <p className="text-sm font-mono text-primary mb-3">// ORGANIZATIONAL INTELLIGENCE PLATFORM</p>
            <h2
              className={`text-3xl lg:text-5xl font-semibold tracking-tight mb-6 transition-all duration-700 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
            >
              <span className="text-balance">Everything your organization knows.</span>
              <br />
              <span className="text-balance">Connected.</span>
            </h2>
            <p
            ...
            >
              Project Phoenix transforms fragmented enterprise knowledge into a continuously evolving Digital Brain that understands people, systems, decisions, and dependencies.
            </p>
          </div>
