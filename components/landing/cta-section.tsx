            ...
            <div className="flex items-center justify-between gap-8">
              <div className="max-w-2xl">
                <h2 className="text-3xl lg:text-5xl font-semibold tracking-tight mb-6 text-background text-balance">
                  Turn scattered knowledge into organizational intelligence.
                </h2>

                <p className="text-lg text-background/70 mb-8 leading-relaxed max-w-lg">
                  Stop losing decisions, context, and expertise across tools. Launch Project Phoenix and give your organization a living Digital Brain that continuously learns, explains, and evolves.
                </p>
                ...
                <p className="text-sm text-background/50 mt-6 font-mono">
                  No credit card required · Enterprise-ready · Deploy in minutes
                </p>
              </div>
